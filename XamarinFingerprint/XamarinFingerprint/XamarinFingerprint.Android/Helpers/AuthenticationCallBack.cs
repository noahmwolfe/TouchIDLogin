...
namespace XamarinFingerprint.Droid.Helpers
{
    class AuthenticationCallBack : FingerprintManagerCompat.AuthenticationCallback
    {
        ...
        public override void OnAuthenticationError(int errMsgId, ICharSequence errString)
        {
            ...
            MessagingCenter.Send<string, string>("FingerprintAuthentication", "Authenticate", "fail");
        }
        ...
        public override void OnAuthenticationFailed()
        {
            ...
            MessagingCenter.Send<string, string>("FingerprintAuthentication", "Authenticate", "false");
        }
